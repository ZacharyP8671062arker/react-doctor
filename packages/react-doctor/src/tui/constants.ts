...
export const CATEGORY_BREAKDOWN_DEFAULT_LIMIT = 5;

export const CATEGORY_BAR_MAX_WIDTH_CHARS = 14;

export const CATEGORY_BAR_MIN_WIDTH_CHARS = 6;

export const CATEGORY_BREAKDOWN_MIN_CATEGORIES = 2;
